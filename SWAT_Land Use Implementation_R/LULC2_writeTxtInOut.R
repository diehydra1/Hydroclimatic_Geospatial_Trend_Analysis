...
# USER DEFINE PARAMETER - PLEASE CHANGE ONLY WITHIN THIS PART           # 	
	...
	Lu[1] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/1992/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 1992
	Lu[2] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/1993/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 1993
	Lu[3] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/1994/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 1994
	Lu[4] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/1995/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 1995
	Lu[5] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/1996/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 1996
	Lu[6] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/1997/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 1997
	Lu[7] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/1998/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 1998
	Lu[8] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/1999/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 1999
	Lu[9] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2000/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2000
	Lu[10] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2001/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2001
	Lu[11] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2002/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2002
	Lu[12] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2003/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2003
	Lu[13] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2004/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2004
	Lu[14] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2005/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2005
	Lu[15] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2006/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2006
	Lu[16] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2007/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2007
	Lu[17] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2008/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2008
	Lu[18] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2009/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2009
	Lu[19] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2010/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2010
	Lu[20] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2011/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2011
	Lu[21] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2012/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2012
	Lu[22] <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/1_QSWAT16_10sqkm/2013/QSWAT16/Scenarios/Sim2_Monthly_PenmanMonteith/TxtInOut"    # e.g. TxtInout folder with land use 2013
...
#	inter_date[[2]] <- c("NA")	               # change to inter_date[[2]] <- c("NA") if you don't need to interpolate
	...
	ofolder <- "D:/Model4_RS_LocalPCP_39Subs_1207HRUs/2_RStudio_LanduseChange/5_Scenarios/Sim2_Monthly_All_IDW_HRU1207_PenmanMonteith/newTxtInOut"                                   # Diretory to store new TxtInOut
