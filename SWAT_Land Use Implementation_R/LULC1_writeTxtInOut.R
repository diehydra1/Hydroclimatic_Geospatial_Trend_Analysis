...
# USER DEFINE PARAMETER - PLEASE CHANGE ONLY WITHIN THIS PART           # 	
	...
	Lu[1] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[2] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[3] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[4] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[5] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[6] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[7] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[8] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[9] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[10] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[11] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[12] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[13] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[14] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[15] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[16] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[17] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[18] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[19] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[20] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[21] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	Lu[22] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	#Lu[23] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	#Lu[24] <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/TxtInOut"    # e.g. TxtInout folder with land use 1990
	...
	date <- c("01011992","01011993","01011994","01011995","01011996","01011997","01011998","01011999","01012000","01012001","01012002","01012003","01012004","01012005","01012006","01012007","01012008","01012009","01012010","01012011","01012012","01012013") 			   # Date (ddmmyyyy) of the three land use above
#	inter_date[[1]] <- c("NA")       # change to inter_date[[1]] <- c("NA") if you don't need to interpolate
#	inter_date[[2]] <- c("NA")	               # change to inter_date[[2]] <- c("NA") if you don't need to interpolate


	ofolder <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/5_Scenarios/Sim1_Daily_All_IDW_PCPLocal/newTxtInOut"                                   # Diretory to store new TxtInOut
	hru_lu_all <- "G:/Dokumente/University/Masterarbeit_25.10.2019/ArcGIS/Projektdata_QGIS/Model3_RS_LocalPCP/2_RStudio_LanduseChange/3_Create_Output_File_hru_all_landuse_reprort.R/hru_lu_1992-2013.txt"			         # Location and the file name created from step 2   
